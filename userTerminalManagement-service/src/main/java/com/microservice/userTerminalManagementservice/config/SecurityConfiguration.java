...
import static com.microservice.userTerminalManagementservice.domain.user.Role.ADMIN;
import static com.microservice.userTerminalManagementservice.domain.user.Role.TEAMLEAD;
import static com.microservice.userTerminalManagementservice.domain.user.Role.OPERATOR;
